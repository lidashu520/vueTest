  ...
  <div class="container bgF">
    ...
    <ul class="formCom form-login">
      <li>
        <label>
          <span>手机号</span>
          <input type="number" placeholder="请输入手机号" v-model.number='reqForm.phone'/>
        </label>
      </li>
      <li>
      ...
      <li :class="showPwdOne?'icon-eye1':'icon-eye2'">
        <label>
          <span>登录密码</span>
          <input :type="showPwdOne?'password':'text'" placeholder="请输入6-12位密码" v-model.trim='reqForm.pwdOne'>
      ...
      <li :class="showPwdTwo?'icon-eye1':'icon-eye2'">
        <label>
          <span>确认密码</span>
          <input :type="showPwdTwo?'password':'text'" placeholder="请输入6-12位确认密码" v-model.trim='reqForm.pwdTwo'>
