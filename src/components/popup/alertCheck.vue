    ...
    <div class="alertCheckCon">
      ...
      <ul class="forms">
        ...
        <li class="liWarp">
         ...
         <li>
          <input type="password" placeholder="请输入新密码" class="inputType1" v-model.trim='password'>
        </li>

         <li>
          <input type="password" placeholder="确认密码" class="inputType1" v-model.trim='confirmpwd'>
        </li>
      </ul>
